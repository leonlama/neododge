...
class WaveManager:
    ...
    def __init__(self, player=None):
        ...
        self._show_wave_message(f"Wave {self.current_wave}")
    ...
    def update(self, delta_time):
        ...
        # If in wave transition, don't update the wave timer
    ...
    def is_wave_complete(self):
        """Check if the current wave is complete based on time."""
        duration = self.rest_duration if self.is_rest_wave else self.wave_duration
        return self.wave_timer >= duration
    ...
    def _complete_wave(self):
        ...
        self._show_wave_message(f"Wave {self.current_wave} Completed!")
    ...
    def _check_special_events(self):
        ...
        if self.current_wave % 5 == 0:
            ...
            arcade.schedule(
                lambda dt: self._show_wave_message(f"Milestone Wave {self.current_wave}!"),
